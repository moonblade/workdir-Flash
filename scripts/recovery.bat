...
color 70
CLS
set stepname=RECOVERY
title %stepname%

:FLSIMG
echo.
ECHO Select The RECOVERY from the following list.
ECHO.
...
ECHO.
essentials\fastboot flash recovery RECOVERY/IMG/%_FileName%
